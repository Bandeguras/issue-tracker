...
from webapp.views import TaskIndex, TaskView, TaskCreate, TaskUpdate, TaskDelete, ProjectIndex, ProjectView, ProjectCreate
...
urlpatterns = [
    ...
    path('task/index/', TaskIndex.as_view(), name='index'),
